...
export default function Leaderboard() {
  ...
  function onClick() {
    if (
      ...
      visiblePlayers.length + 10 >= players.length
    ) {
  ...
  return (
    <div
      className="relative overflow-hidden flex flex-col items-center justify-center w-full max-w-[25rem] shadow-md border-[1px] border-gray-400 rounded-[10px]"
    ...
    >
      <div className="p-8 border-b-[1px] border-gray-400 w-full flex flex-col items-center justify-center">
        <div className="flex items-center justify-between w-full mb-4">
          ...
          <p className="text-[#DAF1D6] font-bold uppercase text-2xl">
            Leaderboard
          </p>
          <img alt="icon" src="star_icon.svg" />
        </div>
      ...
      <div className="w-full p-4">
        ...
        {selectedGame === "" && (
          <p className="text-white text-xl p-20">
            You have to choose a game to see the players leaderboard.
          </p>
        )}
      </div>
