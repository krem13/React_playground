...
export default function TruckCard(props: TruckCardProps) {
  return (
    <Link to={props.page}>
      <div className="!mb-10 max-w-[400px] rounded-md border-2 border-gray-400 bg-zinc-950 hover:bg-zinc-900 transition-colors">
        <div className="flex items-center justify-between mx-1 my-auto p-2.5">
          <div>
        ...
        <div className="flex max-w-[360px] mt-4">
          <img
        ...
        <div className="my-auto px-2.5 py-4 border-t border-gray-400">
          <div className="mx-1 !mb-2 bg-[#2c2c2c] p-2.5 text-[#c2c2c2] flex align-middle justify-between rounded-md">
            <p>Energy source</p>
          ...
          <div className="mx-1 bg-[#2c2c2c] p-2.5 text-[#c2c2c2] flex align-middle justify-between rounded-md">
            <p>Capacity</p>
